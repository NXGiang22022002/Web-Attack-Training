    ...
    <div class="list">
      <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="card">
          ...
          <p class="desc"><?php echo e($a->description); ?></p>

          <p>
            <a class="download-link" href="<?php echo e(route('student.assignments.download', $a->id)); ?>">Tải file bài tập</a>
          </p>

          <p class="status">
            Trạng thái:
            <?php if(isset($my[$a->id])): ?>
              <span class="ok">Đã nộp: <?php echo e($my[$a->id]->file_name); ?></span>
            <?php else: ?>
              <span class="wait">Chưa nộp</span>
            <?php endif; ?>
          </p>

          <form class="submit-form" method="POST" action="<?php echo e(route('student.assignments.submit', $a->id)); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\challenge1\resources\views/student/assignments/index.blade.php ENDPATH**/ ?>